...
%\includegraphics[scale=.23]{http://canvoki.net/images/bichos-low.png}
...
\item[E-mail] voki at canvoki dot net
\end{cvlist}

\begin{cvlist}{Summary}
\item[] I have a wide experience developing software on desktop, web and server applications, and related to audio and multimedia,
all using agile methodologies, testing and open source tools and methods.
Some technologies I recently used are Python, Qt, Kotlin, React, FastApi, C++, Odoo...

I was profesor at Universitat Pompeu Fabra and others institutions for a decade,
teaching Software Engineering and Free/Libre Open Source Software Development methods.
As researcher i was specialized in domains like Audio Software Engineering, 3D Acoustics and Music Information Retrieval.
Some research topics I faced were:
Chord extraction,
visual prototyping of audio applications,
real-time convolution,
and 3D acoustics rendering.

Then, in 2013 I decided to turn into the Social Economy,
first starting up GuifiBaix SCCL, a local Guifi.net deployer,
and then working at Som energia SCCL were we deployed an IT team
from scratch to the current 25 people, innovating on organization technics.

I am also not enclosed to IT topics, I expanded my education and interests
covering topics as wide as
Biology, Physics, Politics, History, Economy, Art and Philosophy.

\end{cvlist}

\begin{cvlist}{Interests}
\item[] Social Economy and Cooperativism, Free and Open Source Software, Agile Software Project Management, Teaching, Music software engineering, Music information retrieval, 3D acoustics simulation, 3D audio production and playback, Emergent evolutionary systems
\end{cvlist}
...
\item[2025 - 2025]
{\bf Course} in {\bf Blender 3D modeling for illustrators}
coursed at {\bf Escola JOSO}.
{\em }
\item[2020 - 2021]
{\bf Course} in {\bf Social Economy Disemination}
coursed at {\bf Universitat de Barcelona}.
{\em }
\item[2018 - 2019]
{\bf Postgraduate} in {\bf Technopolitics and Rights in the Digital Era}
coursed at {\bf Barcelona School of Management}.
{\em }
...
such  as Python, C++, Javascript, Kotlin, PHP, Smalltallk, Java and Bash.


\item[Desktop/Mobile Programming]
	I am quite a fan of Qt technologies for building user interfaces.
I also used MUI (React) and Compose (Android/Kotlin).
I also have used less Tcl/Tk, Gtk and Fltk.


\item[Web Programming]
	I keep track of most web related standards since 1995:
HTML/CSS, XML, XPath, XSD, JSON, YAML...
I worked with different Javascript frontend frameworks such as React, JQuery, Mithril, Angular...
I am experienced with backend programming, both in PHP and Python using frameworks such as FastAPI, Flask and Django.
...
\item[Databases]
	I am an experienced SQL programmer using it directly o thru ORM's.
I have basic experience administrating MySql and Postgresql databases.
...
I did some basic programming in Godot and shaders.


\item[Art/Design]
	I have experience using Gimp (PaintShop equivalent), Inkscape (Freehand/Illustrator equivalent) and Krita (Clip Studio equivalent).
I used them for both artistic and professional purposes.
Basic modeling and texturing using Blender (3D Animation).
...
My later public contributions are mostly hosted in Github
...
\item[Carburoid]
An Open Source Android application to search gas stations. I implemented it to learn Kotlin and in few months it has become a mature and well engineered application with CI, F-Droid distribution, automated web page generation and a bunch of tools and shared components i am using to fastly implement other Android applications.
\footnote{\href{http://carburoid.canvoki.net}{http://carburoid.canvoki.net}}
\item[VokiBot]
An Open Source Android/Kotlin application to launch tasks on many triggering events. Developed in kotlin, it deals with inter-application communication, system discovery, Bluetooth... Reuses many of the shared components and tools from Carburoid.
\footnote{\href{http://vokibot.canvoki.net}{http://vokibot.canvoki.net}}
\item[TestFarm]
